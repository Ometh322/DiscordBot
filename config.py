...
Форматы: gif, apng, png, jpg, webp (принимаем до 32 МБ).
В сообщения «Сейчас играет» идут гифки до 24 МБ — больше Discord
не даёт боту переотправить; сожми, если хочешь её в ротации.
